...
export function RapidGraph({
    ...
    return (
        <>
            ...
            {popoverData && (
                <div
                    className="fixed z-10000 bg-ax-bg-default border border-ax-neutral-400 rounded-lg shadow-lg p-3 pointer-events-none max-w-md"
                    style={{
                    ...
                    <Chips>
                        {gruppeliste.map((namespace) => {
                            return (
                                <Chips.Toggle
                                    key={namespace}
                                    className={namespaceToAkselColor(namespace) + ' text-ax-text-neutral-contrast'}
                                    checkmark={false}
                                >
                                    {namespace}
                                </Chips.Toggle>
